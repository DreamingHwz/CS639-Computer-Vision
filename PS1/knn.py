...
def compute_distances_one_loop(x_train: torch.Tensor, x_test: torch.Tensor):
    ...
    # print("new_x_train[0]: ", new_x_train[0].shape)
    # print("------------------------------------------------------------------------------------")
    # print("new_x_test: ", new_x_test)
    # print("new_x_train[0]: ", new_x_train[0])
    # print("new_x_test - new_x_train[0]: ", new_x_test - new_x_train[0])
    for i in range(0, num_train):
